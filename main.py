...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Ejecuta el detector de paneles sobre las imágenes de test"
    )
    parser.add_argument(
        '--detector', type=str, nargs="?", default="", help='Nombre del detector'
    )
    parser.add_argument(
        '--train_path', default="train_detection", help='Directorio de entrenamiento'
    )
    parser.add_argument(
        '--test_path', default="test_detection", help='Directorio de test'
    )
    ...
    # Evaluate detections
    # Carpeta donde se guardan las imágenes con las detecciones dibujadas
    dir_resultados_imgs = "resultado_imgs"
    if not os.path.exists(dir_resultados_imgs):
        os.makedirs(dir_resultados_imgs)

    # Fichero de salida con el formato pedido en el enunciado
    ...
    for nombre_img in imagenes_test:
        ...
        for det in detecciones:
            ...
            # Formato: nombre;x1;y1;x2;y2;clase;score
    ...
    f_txt.close()
    print(f"\nProceso completado. Archivo '{ruta_resultado_txt}' generado.")
